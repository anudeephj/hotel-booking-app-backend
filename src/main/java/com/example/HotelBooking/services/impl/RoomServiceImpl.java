...
public class RoomServiceImpl implements RoomService {
  ...
  //private static final String IMAGE_DIRECTORY = System.getProperty("user.dir") + "/product-image/";
    ...
    //image directory for our frontendappp
    private static final String IMAGE_DIRECTORY_FRONTEND = "C:/Users/anude/OneDrive/Desktop/hotel-react-frontend/public/rooms/";
...
//    }
    ...
    private String saveImageToFrontend(MultipartFile imageFile){
        ...
        if (!directory.exists()){
            if (!directory.mkdirs()) { // Ensure the directory is created
                throw new IllegalStateException("Failed to create directory: " + IMAGE_DIRECTORY_FRONTEND);
            }
        }
        //Generate uniwue file name for the image
        String uniqueFileName = UUID.randomUUID() + "_" + imageFile.getOriginalFilename();
